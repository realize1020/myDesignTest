...
import com.example.design.miniSpring.config.ConstructorArgumentValue;
import com.example.design.miniSpring.config.PropertyValue;
import com.example.design.miniSpring.config.PropertyValues;
...
public abstract class AbstractAutowireCapableBeanFactory extends AbstractBeanFactory {
    ...
    protected Object createBeanInstance(BeanDefinition beanDefinition) throws RuntimeException {
        Class<?> beanClass = beanDefinition.getBeanClass();
        if (beanClass == null) {
            throw new RuntimeException("Bean class is not set for bean definition");
        }
        ...
        try {
            ...
            throw new RuntimeException("Error creating bean instance for " + beanClass, e);
        }
    }

    protected Object autowireConstructor(BeanDefinition beanDefinition) throws RuntimeException {
        Class<?> beanClass = beanDefinition.getBeanClass();
        ...
        try {
            ...
            throw new RuntimeException("Could not find matching constructor for " + beanClass);
        } catch (Exception e) {
            throw new RuntimeException("Error autowiring constructor for " + beanClass, e);
        }
    }

    protected void populateBean(String beanName, Object bean, BeanDefinition beanDefinition) throws RuntimeException {
