...
public class DefaultListableBeanFactory extends AbstractAutowireCapableBeanFactory
    ...
    @Override
    public void ensureAllSingletonsInstantiated() throws RuntimeException {
    ...
    @Override
    public boolean isSingleton(String name) throws RuntimeException {
        String beanName = transformedBeanName(name);
    ...
    @Override
    public boolean isPrototype(String name) throws RuntimeException {
        String beanName = transformedBeanName(name);
    ...
    @Override
    public <T> Map<String, T> getBeansOfType(Class<T> type) throws RuntimeException {
    ...
    @Override
    public <A extends Annotation> A findAnnotationOnBean(String beanName, Class<A> annotationType) throws RuntimeException {
        BeanDefinition beanDefinition = getBeanDefinition(beanName);
        Class<?> beanClass = beanDefinition.getBeanClass();
    ...
    public <T> T getBean(Class<T> requiredType) throws RuntimeException {
        ...
        if (beanNames.length > 1) {
            throw new RuntimeException("More than one bean of type '" + requiredType.getName() + "' is defined: " +
     ...
     */
    public BeanDefinitionHolder getBeanDefinitionHolder(String beanName) throws RuntimeException {
        BeanDefinition beanDefinition = getBeanDefinition(beanName);
        String[] aliases = getAliases(beanName);
    ...
    protected void destroySingleton(String beanName) {
        ...
        if (singletonInstance != null) {
            ...
            if (beanDefinition != null && beanDefinition.getDestroyMethodName() != null) {
                try {
                    Method destroyMethod = singletonInstance.getClass()
    ...
    @SuppressWarnings("unchecked")
    protected <T> T doGetBean(String name, Class<T> requiredType) throws RuntimeException {
        ...
        if (bean == null) {
            try {
                ...
                throw new RuntimeException("Error creating bean '" + canonicalName + "'", e);
            }
        }
    ...
    protected void validateAlias(String beanName, String alias) {
        ...
        if (hasAlias(alias, beanName)) {
            throw new RuntimeException("Cannot register alias '" + alias + 
    ...
    @Override
    public void autowireBean(Object existingBean) throws RuntimeException {
        logger.debug("Autowiring bean of type [{}]", existingBean.getClass().getName());
    }

    @Override
    public Object configureBean(Object existingBean, String beanName) throws RuntimeException {
    ...
    @Override
    public Object resolveDependency(Class<?> descriptor, String beanName) throws RuntimeException {
    ...
    protected Object initializeBean(String beanName, Object bean, BeanDefinition beanDefinition) {
        ...
        try {
            ...
            throw new RuntimeException("Invocation of init method failed", e);
        }
