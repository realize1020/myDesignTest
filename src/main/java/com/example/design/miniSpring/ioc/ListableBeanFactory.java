...
public interface ListableBeanFactory extends BeanFactory {
     ...
     * @throws RuntimeException 如果获取bean失败
     */
    <T> Map<String, T> getBeansOfType(Class<T> type) throws RuntimeException;
     ...
     */
    <A extends Annotation> A findAnnotationOnBean(String beanName, Class<A> annotationType) throws RuntimeException;
} 